...
STATIC const mp_rom_map_elem_t board_module_globals_table[] = {
  ...
  { MP_ROM_QSTR(MP_QSTR_COIN_I_0), MP_ROM_PTR(&pin_P1_09) },
  { MP_ROM_QSTR(MP_QSTR_COIN_I_1), MP_ROM_PTR(&pin_P1_00) },
  { MP_ROM_QSTR(MP_QSTR_BILL_I_0), MP_ROM_PTR(&pin_P1_11) },
  { MP_ROM_QSTR(MP_QSTR_BILL_O_0), MP_ROM_PTR(&pin_P1_08) },
    
  { MP_ROM_QSTR(MP_QSTR_GP_O_0), MP_ROM_PTR(&pin_P1_05) },    
  { MP_ROM_QSTR(MP_QSTR_GP_O_1), MP_ROM_PTR(&pin_P1_06) },    
  { MP_ROM_QSTR(MP_QSTR_GP_O_2), MP_ROM_PTR(&pin_P1_07) },
  { MP_ROM_QSTR(MP_QSTR_GP_I_0), MP_ROM_PTR(&pin_P1_12) },

  { MP_ROM_QSTR(MP_QSTR_ZP23), MP_ROM_PTR(&pin_P0_24) },
  { MP_ROM_QSTR(MP_QSTR_ZP24), MP_ROM_PTR(&pin_P0_04) },
  ...
  { MP_ROM_QSTR(MP_QSTR_NOTCH_O_0), MP_ROM_PTR(&pin_P1_02) },
  { MP_ROM_QSTR(MP_QSTR_NOTCH_O_1), MP_ROM_PTR(&pin_P1_01) },
