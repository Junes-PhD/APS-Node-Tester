...
STATIC const mp_rom_map_elem_t board_module_globals_table[] = {
  ...
  { MP_ROM_QSTR(MP_QSTR_SERVICE_I_0), MP_ROM_PTR(&pin_P0_16) },
  { MP_ROM_QSTR(MP_QSTR_SERVICE_O_0), MP_ROM_PTR(&pin_P1_00) },
  { MP_ROM_QSTR(MP_QSTR_COIN_LOGIC), MP_ROM_PTR(&pin_P1_07) },
  ...
  { MP_ROM_QSTR(MP_QSTR_TCKT_TYPE), MP_ROM_PTR(&pin_P0_13) },
  { MP_ROM_QSTR(MP_QSTR_TCKT_SEL), MP_ROM_PTR(&pin_P0_24) },
  ...
  { MP_ROM_QSTR(MP_QSTR_SCLK_0), MP_ROM_PTR(&pin_P0_07) },
  { MP_ROM_QSTR(MP_QSTR_MOSI_0), MP_ROM_PTR(&pin_P0_05) },
  { MP_ROM_QSTR(MP_QSTR_MISO_0), MP_ROM_PTR(&pin_P0_06) },
  { MP_ROM_QSTR(MP_QSTR_RST_0), MP_ROM_PTR(&pin_P0_08) },
  { MP_ROM_QSTR(MP_QSTR_INT_0), MP_ROM_PTR(&pin_P0_04) },
  { MP_ROM_QSTR(MP_QSTR_SCS_0), MP_ROM_PTR(&pin_P1_12) },

  { MP_ROM_QSTR(MP_QSTR_TX_0), MP_ROM_PTR(&pin_P0_15) },
  { MP_ROM_QSTR(MP_QSTR_RX_0), MP_ROM_PTR(&pin_P0_14) },
  { MP_ROM_QSTR(MP_QSTR_TX_1), MP_ROM_PTR(&pin_P1_08) },
  { MP_ROM_QSTR(MP_QSTR_RX_1), MP_ROM_PTR(&pin_P1_09) },
